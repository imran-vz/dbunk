...
export function DatabaseNavigator({
  ...
  return (
    ...
    >
      <div className="border-b border-border-subtle px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-text-muted">
        Database navigator
      </div>
          ...
          return (
            <div key={schemaId} className="mb-1">
              <button
                ...
                className="flex w-full items-center gap-1.5 rounded px-2 py-1 text-[11px] font-medium text-text-secondary hover:bg-surface-panel"
              >
                {isExpanded ? (
                ...
                ? schema.tables.map((table) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "flex w-full items-center gap-2 rounded py-1.5 pr-2 pl-6 text-left text-[12px] transition-colors",
                          on
